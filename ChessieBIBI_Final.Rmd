...
Now that the data are in the proper format and the samples have been rarefied, the biological metrics can be calcualted. To streamline this process, all of the metrics are computed for each unique sampling event (unique_id). Later on, metrics specific to each bioregion will be selected.  
...
slices <- c(16.84758, 21.29193, 18., 28.17866, 15.44177)
