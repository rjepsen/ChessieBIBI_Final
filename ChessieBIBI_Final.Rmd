 ...
 ## 
  taxa_count <- rare %>%
   ...
   pct_ept_rich <- rare %>%
    ...
    pct_ept_rich2 <- merge(pct_ept_rich, family_richness, be= "unique_id", all=TRUE)
    pct_ept_rich2[is.na(pct_ept_rich2)] <- 0
    metrics.key$pct_ept_rich2 <- (pct_ept_rich2$rich_ept / pct_ept_rich2$family_richness)*100
